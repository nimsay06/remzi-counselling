    ...
    <>
      <div className="min-h-screen text-center overflow-auto p-6 text-dark-green m-8 md:m-auto xl:text-lg md:w-2/3">
        ...
        <p>
          ...
          safe and compassionate space. We will explore my integrative approach
          so that you have an understanding of how it can support your growth
          and well-being. By the end of the session, you will have a clearer
          understanding of how we can work together to achieve your personal
