...
export default function Footer() {
  return (
    <footer className="bg-dark-green font-SourceSans md:p-2 text-peach-brown bottom-0 w-full h-16 md:h-24 grid grid-cols-2 md:grid-cols-3 grid-flow-row text-wrap border-3 border-main ">
      <h2 className="hidden md:block font-Taviraj text-2xl m-auto">
        Deon Remzi Counselling
      </h2>
      <img src={logo} className="w-5/12 h-5/12 md:h-20 md:w-24 m-auto" />
      <div className="md:grid md:text-end p-0">
        <div className=" emailSect ">
          ...
          <h2 className=" md:ml-2 inline md:text-lg text-sm">
            DeonRemzi@hotmail.com
          </h2>
        </div>

        <br />
        <div className="phoneNumberSect -mt-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <h2 className=" md:ml-2 inline md:text-lg text-sm">07470356685</h2>
        </div>
      </div>
    </footer>
  );
