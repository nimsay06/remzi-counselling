...
export default function Footer() {
  return (
    <footer className="bg-dark-green font-Abel md:p-2 text-peach-brown bottom-0 w-full h-16 md:h-14 grid grid-cols-2 md:grid-cols-3 grid-flow-row border-3 border-main ">
      ...
      <div className="  md:grid md:text-end p-0">
        ...
        <div className="phoneNumberSect -mt-4 md:-mt-7">
          ...
          <h2 className=" md:ml-2 inline md:text-lg text-md ">07470356685</h2>
        </div>
      </div>
    </footer>
  );
